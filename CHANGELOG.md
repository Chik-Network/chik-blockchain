...
## 2.5.5 Chik blockchain 2025-08-19
...
- Add `chik dev mempool` CLI commands to import, export, and benchmark the mempool
...
- move `chik.types.aliases` to `chik.server.aliases`
- move tx processing queue entry classes
- Improve the serialisation of AddressManager
- Remove the dependency of `chik.consensus` on the module `chik.types`
