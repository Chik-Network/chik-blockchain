...
import pytest
from chik_rs import ConsensusConstants, FullBlock, PartialProof, ProofOfSpace
...
from chik.plotting.prover import V1Prover, V2Prover, V2Quality
from chik.plotting.util import PlotInfo
from chik.protocols import harvester_protocol
from chik.protocols.harvester_protocol import PoolDifficulty
...
async def test_request_plots_uses_plot_serialization_for_farmer_protocol(
    ...
    peer = MagicMock(spec=WSChikConnection)
...
def create_test_setup(
    ...
    mock_peer = MagicMock(spec=WSChikConnection)
