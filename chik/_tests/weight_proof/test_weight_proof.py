...
import chik.full_node.weight_proof as weight_proof_module
...
from chik.consensus.pot_iterations import validate_pospace_and_get_required_iters
from chik.consensus.stub_mmr_manager import StubMMRManager
from chik.full_node import weight_proof
from chik.full_node.weight_proof import (
    WeightProofHandler,
...
class TestWeightProof:
    ...
    # chik.types.blockchain_format.proof_of_space: ERROR Calculated pos
