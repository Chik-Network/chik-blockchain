...
from chik.wallet.wallet_request_types import CATAssetIDToName, CATAssetIDToNameResponse
...
async def test_print_offer_summary_xck(capsys: Any) -> None:
    summary_dict = {"xck": str(1_000_000_000_000)}
