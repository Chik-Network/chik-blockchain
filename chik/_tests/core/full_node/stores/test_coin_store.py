...
import aiosqlite
import pytest
from chik_rs import CoinRecord, CoinState, FullBlock, additions_and_removals, get_flags_for_height_and_constants
...
from chik.consensus.block_generator_info import block_has_transactions_generator, get_transactions_generator_bytes
...
async def test_get_coin_records_by_parent_ids_max_items_across_batches(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("chik.full_node.coin_store.SQLITE_MAX_VARIABLE_NUMBER", 5)
