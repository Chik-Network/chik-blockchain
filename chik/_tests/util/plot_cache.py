...
from chik_rs import solve_proof as _orig_solve_proof
from chik_rs.sized_bytes import bytes32
from filelock import FileLock

from chik.plotting.prover import QualityProtocol, V1Prover, V1Quality, V2Prover, V2Quality
...
def install(plot_dir: Path) -> None:
    ...
    setattr(__import__("chik.simulator.block_tools", fromlist=["solve_proof"]), "solve_proof", cached_solve_proof)
    setattr(__import__("chik.solver.solver", fromlist=["solve_proof"]), "solve_proof", cached_solve_proof)
