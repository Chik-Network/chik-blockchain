"""
Tests for chik.rpc.rpc_errors: RpcError and structured_error_from_exception.
"""

from __future__ import annotations

from chik.rpc.rpc_errors import RpcError, RpcErrorCodes, structured_error_from_exception
from chik.util.errors import ApiError as UtilApiError
from chik.util.errors import ConsensusError, Err, ProtocolError, TimestampError, ValidationError
