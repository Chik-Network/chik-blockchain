...
from chik._tests.clvk.coin_store import CoinStore, CoinTimestamp
...
def do_test_spend(
    ...
    coin_db.update_coin_store_for_spend_bundle(spend_bundle, spend_time, MAX_BLOCK_COST_CLVK)
