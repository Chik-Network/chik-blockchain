...
async def test_nft_offer_with_fee(wallet_environments: WalletTestFramework) -> None:
    ...
    wallet_maker = env_0.xck_wallet
    wallet_taker = env_1.xck_wallet
    ...
    xck_request = 100
    maker_fee = uint64(10)
    offer_nft_for_xck: dict[int | bytes32, int] = {wallet_maker.id(): xck_request, nft_asset_id: -1}
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                ...
                post_block_balance_updates={
                    "xck": {
                        "unconfirmed_wallet_balance": -maker_fee + xck_request,
                        "confirmed_wallet_balance": -maker_fee + xck_request,
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_coin_removal_count": -1,
                        "unspent_coin_count": 1,
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "xck": {
                        "unconfirmed_wallet_balance": -(xck_request + taker_fee),
                ...
                post_block_balance_updates={
                    "xck": {
                        "confirmed_wallet_balance": -(xck_request + taker_fee),
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "<=#pending_change": -1,
                        "pending_coin_removal_count": -1,
    ...
    xck_offered = 1000
    maker_fee = uint64(10)
    offer_xck_for_nft: dict[int | bytes32, int] = {wallet_maker.id(): -xck_offered, nft_to_buy_asset_id: 1}
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={
                    "xck": {
                        "<=#spendable_balance": -(xck_offered + maker_fee),
                        "<=#max_send_amount": -(xck_offered + maker_fee),
                        "pending_coin_removal_count": 1,
                    },
                    "nft": {},
                },
                post_block_balance_updates={
                    "xck": {
                        "unconfirmed_wallet_balance": -(xck_offered + maker_fee),
                        "confirmed_wallet_balance": -(xck_offered + maker_fee),
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_coin_removal_count": -1,
                    },
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "xck": {
                        "unconfirmed_wallet_balance": -taker_fee + xck_offered,
                        "<=#spendable_balance": -(xck_offered + maker_fee),
                        "<=#max_send_amount": -(xck_offered + maker_fee),
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                ...
                post_block_balance_updates={
                    "xck": {
                        "confirmed_wallet_balance": -taker_fee + xck_offered,
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "<=#pending_change": -1,
                        "pending_coin_removal_count": -1,
...
async def test_nft_offer_cancellations(wallet_environments: WalletTestFramework) -> None:
    ...
    xck_request = 100
    maker_fee = uint64(10)
    offer_nft_for_xck: dict[bytes32 | int, int] = {wallet_maker.id(): xck_request, nft_asset_id: -1}
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={
                    "xck": {
                        "<=#spendable_balance": -(maker_fee + maker_xck_offered),
                        "<=#max_send_amount": -(maker_fee + maker_xck_offered),
                        "pending_coin_removal_count": 1,
                    },
                    "taker cat": {},
                    "nft": {
                ...
                post_block_balance_updates={
                    "xck": {
                        "unconfirmed_wallet_balance": -(maker_fee + maker_xck_offered),
                        "confirmed_wallet_balance": -(maker_fee + maker_xck_offered),
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_coin_removal_count": -1,
                    },
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "xck": {
                        "unconfirmed_wallet_balance": -taker_fee + maker_xck_offered,
                        "<=#spendable_balance": -taker_fee + maker_xck_offered,
                        "<=#max_send_amount": -taker_fee + maker_xck_offered,
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                    },
                    "taker cat": {
                ...
                post_block_balance_updates={
                    "xck": {
                        "confirmed_wallet_balance": -taker_fee + maker_xck_offered,
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "<=#pending_change": -1,
                        "pending_coin_removal_count": -1,
