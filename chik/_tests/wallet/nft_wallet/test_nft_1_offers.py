    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                ...
                post_block_balance_updates={
                    "xck": {
                        "confirmed_wallet_balance": (xck_requested + expected_royalty) - maker_fee,
                        "unconfirmed_wallet_balance": (xck_requested + expected_royalty) - maker_fee,
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "xck": {
                        "unconfirmed_wallet_balance": -(taker_fee + xck_requested + expected_royalty),
                        "<=#spendable_balance": -(taker_fee + xck_requested + expected_royalty),
                        "<=#max_send_amount": -(taker_fee + xck_requested + expected_royalty),
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                    },
                    "nft": {
                ...
                post_block_balance_updates={
                    "xck": {
                        "confirmed_wallet_balance": -(taker_fee + xck_requested + expected_royalty),
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "<=#pending_change": -1,
                        "pending_coin_removal_count": -1,
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={
                    "xck": {
                        "<=#spendable_balance": -(maker_fee + xck_offered + expected_royalty),
                        "<=#max_send_amount": -(maker_fee + xck_offered + expected_royalty),
                        "pending_coin_removal_count": 1,
                    },
                    "nft": {
                        "init": True,
                ...
                post_block_balance_updates={
                    "xck": {
                        "confirmed_wallet_balance": -(maker_fee + xck_offered + expected_royalty),
                        "unconfirmed_wallet_balance": -(maker_fee + xck_offered + expected_royalty),
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_coin_removal_count": -1,
                    },
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "xck": {
                        ...
                        "unconfirmed_wallet_balance": xck_offered - taker_fee,
                ...
                post_block_balance_updates={
                    "xck": {
                        "confirmed_wallet_balance": xck_offered + expected_royalty - taker_fee,
...
async def test_complex_nft_offer(
    ...
    HALF_XCK_REQUESTED = int(XCK_REQUESTED / 2)
    complex_nft_offer = {
        cat_wallet_maker.id(): CAT_REQUESTED * -1,
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                ...
                post_block_balance_updates={
                    "xck": {
                        "confirmed_wallet_balance": HALF_XCK_REQUESTED,
                        "unconfirmed_wallet_balance": HALF_XCK_REQUESTED,
                        "spendable_balance": HALF_XCK_REQUESTED,
                        "max_send_amount": HALF_XCK_REQUESTED,
