...
from chik_rs.chik_rs import G2Element
from chik_rs.sized_bytes import bytes32
from chik_rs.sized_ints import uint32, uint64

from chik._tests.environments.wallet import WalletStateTransition, WalletTestFramework
from chik.pools.plotnft_drivers import PlotNFT, PoolConfig, UserConfig
...
from chik.wallet.wallet_action_scope import PlotNFTTargetStateInfo
...
async def test_plotnft_errors(wallet_environments: WalletTestFramework, self_hostname: str) -> None:
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={"xck": {"set_remainder": True}, "plotnft": {"set_remainder": True}},
                post_block_balance_updates={"xck": {"set_remainder": True}, "plotnft": {"set_remainder": True}},
            )
        ]
    )
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={"xck": {}, "plotnft": {}},
                post_block_balance_updates={"xck": {}, "plotnft": {}},
            )
        ],
