...
async def ignore_block_validation(
    ...
    monkeypatch.setattr(
        "chik.consensus.multiprocess_validation.validate_pospace_and_get_required_iters", lambda *_, **__: uint64(0)
    )
    monkeypatch.setattr("chik_rs.BlockRecord.sp_total_iters", lambda *_: uint128(0))
    monkeypatch.setattr("chik_rs.BlockRecord.ip_sub_slot_total_iters", lambda *_: uint128(0))
    ...
    monkeypatch.setattr("chik_rs.BlockRecord.sp_sub_slot_total_iters", lambda *_: uint64(1))
