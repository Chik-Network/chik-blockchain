...
from chik_rs import BlockRecord, CoinSpend, CoinState, G1Element, G2Element
...
from chik.data_layer.data_layer_util import OfferStore, StoreProofs, leaf_hash
...
class DataLayerWallet:
    ...
    async def make_update_offer(
        ...
        for asset_id in offer_dict:
            if asset_id is None:
                raise ValueError("DataLayer update offers cannot include an XCK leg")
