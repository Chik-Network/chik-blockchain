...
from chik_rs import CoinSpend, CoinState, G1Element
...
from chik.types.blockchain_format.program import Program, run
...
from chik.wallet.cat_wallet.cat_info import CATCoinData, CATInfo, CRCATInfo, LegacyCATInfo
...
from chik.wallet.vc_wallet.vc_drivers import match_revocation_layer
...
class CATWallet:
    ...
    def max_send_quantity(self) -> int:
        ...
        return int(self.wallet_state_manager.constants.MAX_BLOCK_COST_CLVK / 2 / self.cost_of_single_tx)
