...
from chik_rs import CoinSpend, G1Element, G2Element, PrivateKey
...
class Wallet:
    ...
    def max_send_quantity(self) -> int:
        ...
        return int(self.wallet_state_manager.constants.MAX_BLOCK_COST_CLVK / 5 / self.cost_of_single_tx)
