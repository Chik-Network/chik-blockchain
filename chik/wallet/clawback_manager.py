...
from chik_rs import Coin, CoinSpend, CoinState, G2Element
...
from chik.util.streamable import UInt32Range, UInt64Range, VersionedBlob
...
from chik.wallet.puzzles.clawback.drivers import generate_clawback_spend_bundle
    ...
    async def spend_clawback_coins(
        ...
        for coin, metadata in clawback_coins.items():
            try:
                ...
                inner_puzzle = self.xck_wallet.puzzle_for_pk(derivation_record.pubkey)
                inner_solution = self.xck_wallet.make_solution(
                    primaries=[
                        CreateCoin(
