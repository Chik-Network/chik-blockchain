...
from chik_rs import BlockRecord, FullBlock, SubEpochChallengeSegment
...
class BlockStoreProtocol(Protocol):
    """
    The block store interface used by `chik.consensus`.
    This is a substitute for importing from chik.full_node.block_store directly.
