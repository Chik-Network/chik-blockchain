...
from chik.consensus.generator_validation import validate_generator_ref_list
...
from chik.util.priority_thread_pool_executor import Executor, _SupportsLessThan
    ...
    *,
    ...
    try:
        ...
        if conds is not None:
            ...
            if block.transactions_info.cost > constants.MAX_BLOCK_COST_CLVK:
            ...
            # checks reject that before the expensive CLVK run.
            generator_bytes = get_transactions_generator_bytes(block)
            assert generator_bytes is not None
