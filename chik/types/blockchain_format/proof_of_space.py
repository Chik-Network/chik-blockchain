...
def compute_plot_group_id(strength: int, plot_public_key: G1Element, pool_info: G1Element | bytes32) -> bytes32:
    ...
    Verified to match chik_rs compute_plot_id_v2 internals.
    """
...
# TODO: todo_v2_plots move FILTER_WINDOW_SIZE and _BASE_FILTER_OFFSETS to ConsensusConstants in chik_rs
