...
from chik.types.blockchain_format.program import DEFAULT_FLAGS, INFINITE_COST, Program, _run, run_with_cost
...
def compute_block_cost(
    ...
    if height >= constants.HARD_FORK_HEIGHT:
        ...
        klvm_cost, result = _run(GENERATOR_MOD, INFINITE_COST, DEFAULT_FLAGS, [generator, block_program_args])
