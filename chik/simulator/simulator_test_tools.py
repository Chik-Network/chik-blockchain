...
async def start_simulator(chik_root: Path, automated_testing: bool = False) -> AsyncIterator[FullNodeSimulator]:
    ...
    with Lockfile.create(daemon_launch_lock_path(chik_root)):
        ...
        async with SignalHandlers.manage() as signal_handlers:
            ...
            async with ws_server.run():
                async with start_simulator(chik_root, automated_testing) as simulator:
