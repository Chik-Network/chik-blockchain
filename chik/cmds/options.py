...
from chik.cmds.param_types import TransactionFeeParamType
...
def create_fee(message: str = "Set the fees for the transaction, in XCK", required: bool = True) -> Callable[[FC], FC]:
    return click.option(
        "-m",
        "--fee",
        help=message,
