...
def set_cmd(
    ...
    from chik.cmds.passphrase_funcs import (
...
def display_hint() -> None:
    from chik.cmds.passphrase_funcs import display_passphrase_hint
...
def set_hint(hint: str) -> None:
    from chik.cmds.passphrase_funcs import set_passphrase_hint
...
def remove_hint() -> None:
    from chik.cmds.passphrase_funcs import remove_passphrase_hint
