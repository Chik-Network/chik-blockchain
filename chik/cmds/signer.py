...
from chik.cmds.cmd_classes import NeedsWalletRPC, chik_command, command_helper, option
...
from chik.rpc.wallet_request_types import ApplySignatures, ExecuteSigningInstructions, GatherSigningInfo
...
@chik_command(signer_cmd, "apply_signatures", "Apply a signer's signatures to a transaction bundle")
...
@chik_command(signer_cmd, "execute_signing_instructions", "Given some signing instructions, return signing responses")
...
@chik_command(wallet_cmd, "push_transactions", "Push a transaction bundle to the wallet to send to the network")
