...
| `clvk`             | no network harness, or `sim_and_client`                                  | `SpendSim.farm_block`                                          | `sim_client.push_tx`                                                                               | direct CLVK/coin-store assertions, `pytest.raises`                            |
...
| `generator`        | pure generator/CLVK tests                                                | none                                                           | none                                                                                               | deterministic program output/cost assertions                                  |
