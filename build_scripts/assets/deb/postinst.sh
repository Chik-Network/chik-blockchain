...
#
# The profile is shipped at /opt/chik/resources/apparmor-profile but is inert
...
APPARMOR_PROFILE_SOURCE='/opt/chik/resources/apparmor-profile'
APPARMOR_PROFILE_TARGET='/etc/apparmor.d/chik-blockchain'
